...
# Ayuda & Soporte
Si tiene algun problema o incidente por el ModPE, reportelo en las dudas para seguir dando soporte a este ModPE. Antes de reportar un incidente asegurese de tener la version mas reciente y estable de este ModPE.

# Obtener OrbitalTNT
Haga un archivo .js en un editor adecuado y uselo o descargue el archivo "OrbitalTNT.js" e instale el ModPE en un entorno adecuado (Cliente toolbox mcpe 0.15.10)
...
# Licencia
https://github.com/zTheUniverseDev/UVFun-OrbitalTNT/blob/main/LICENSE
